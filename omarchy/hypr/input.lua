-- Tracked in the dotfiles repo as omarchy/hypr/input.lua and symlinked to
-- ~/.config/hypr/input.lua. Omarchy's own defaults live in
...
-- Rolagem estilo macOS: o conteudo acompanha os dedos.
hl.config({
  input = {
    touchpad = {
      natural_scroll = true,
