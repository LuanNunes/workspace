...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    # Single line: the command is typed right after the ❯, no newline.
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # time                  # current time
    # No second line — everything above shares the single prompt line.
  ...
  # The ╭─ ├─ ╰─ frame only makes sense on a multi-line prompt; this one is a
  # single line, so the connectors are blank.
  ...
  # Inline after the last block: one space on each side so the ❯ doesn't touch
  # the powerline separator or the command being typed.
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#e0af68'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='#414868'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND='#414868'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND='#414868'
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND='#c0caf5'
  typeset -g POWERLEVEL9K_ASDF_BACKGROUND='#414868'
  ...
  typeset -g POWERLEVEL9K_ASDF_NODEJS_FOREGROUND='#1a1b26'
  typeset -g POWERLEVEL9K_ASDF_NODEJS_BACKGROUND='#9ece6a'
  ...
  typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_FOREGROUND='#1a1b26'
  typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_BACKGROUND='#bb9af7'
  ...
  typeset -g POWERLEVEL9K_ASDF_LUA_FOREGROUND='#1a1b26'
  typeset -g POWERLEVEL9K_ASDF_LUA_BACKGROUND='#7aa2f7'
  # typeset -g POWERLEVEL9K_ASDF_LUA_VISUAL_IDENTIFIER_EXPANSION='⭐'
  # typeset -g POWERLEVEL9K_ASDF_LUA_SHOW_ON_UPGLOB='*.foo|*.bar'

  # Java version from asdf.
  typeset -g POWERLEVEL9K_ASDF_JAVA_FOREGROUND='#1a1b26'
  typeset -g POWERLEVEL9K_ASDF_JAVA_BACKGROUND='#f7768e'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND='#414868'
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='#e0af68'
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND='#414868'
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#c0caf5'
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND='#414868'

  # Context format when running with privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%n@%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@%m'
  # Default context format (no privileges, no SSH): just the user name — the
  # hostname adds nothing on a single WSL box.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n'

  # Upstream hides the segment outside SSH/sudo by blanking its expansion; we
  # keep it always visible, so that line is intentionally absent here.
